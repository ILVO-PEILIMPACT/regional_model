...
repos_LOCAL <- "file:./Local"                 # path to LOCAL-repository
...
pkg_load <- c("stringr", "fs", "progress", "tibble", "dplyr", "reshape2","readr", "ggplot2", "ggpubr","lubridate", "grid", "ascR", "controlR", "KNMItools", "RSQLite", "SWAPtools","WWLanalyse")
